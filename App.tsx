        ...
        <View style={[styles.row, { alignItems: "stretch", marginTop: 50 }]}>
          <View>
            <Tooltip
              ...
              popover={
                <Text>
                  Note that the tooltip wraps the parent View. This is because
                  it takes the measurement from the parent. Also it's not smart
                  enought to grow based on the size of the text, you have to
                  imperatively add width and height
                </Text>
              }
            >
              <Text>Big Text</Text>
      ...
      <View style={[styles.row, { alignItems: "stretch" }]}>
        <View>
          <Tooltip
            ...
            popover={
              <Text>
                Note that the tooltip wraps the parent View. This is because it
                takes the measurement from the parent. Also it's not smart
                enought to grow based on the size of the text, you have to
                imperatively add width and height
              </Text>
            }
              ...
              <ScrollView style={{ width: 300, height: 200 }}>
                <View onStartShouldSetResponder={() => true}>
                  <Text>
                    ...
                    Consequuntur quia tenetur tempora quibusdam cupiditate non
                    architecto deserunt amet, ipsam fuga quae maxime suscipit
                    dignissimos, dicta minus sit commodi eius quod.
                  </Text>
                  <Text>
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                    Consequuntur quia tenetur tempora quibusdam cupiditate non
...
const WithAutoHeight = ({ navigation }) => {
  return (
    <SafeAreaView style={styles.allOverContainer}>
      <View style={{ height: 100, justifyContent: "center", width: 100 }}>
        <Tooltip
...
const HomeScreen = ({ navigation }) => {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      />
      <Showcase
        onPress={() => navigation.navigate("WithAutoHeight")}
        title="With Auto Height"
        description="Test the usage of auto height"
      />
    </ScrollView>
  );
};
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen name="WithAutoHeight" component={WithAutoHeight} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
